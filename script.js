/**
 * DONE: Create a keydown listner to track what keys are hit
...
let beats = {
    "65": {
        ...
        button: new Button("#0080ff",65),
    },
    "83": {
        beat: new Beat("./assets/Piano Chord 209.mp3"),
        button : new Button("#0080ff",83),
    },
    "68": {
        beat: new Beat("./assets/Piano Chord 208.mp3"),
        button : new Button("#0080ff",68),
    },
    "70": {
        beat: new Beat("./assets/Drum Sticks Hit 3.mp3"),
        button : new Button("#8000ff",70),
    },
    "71": {
        beat: new Beat("./assets/Drum Snare Roll.mp3"),
        button : new Button("#8000ff",71),
    },
    "72": {
